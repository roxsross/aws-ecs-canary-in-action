...
CANARY_LISTENER_ARN CANARY_PRODUCTION_RULE_ARN CANARY_TG_PRIMARY CANARY_TG_ALTERNATE \
CANARY_SERVICE CANARY_TASKDEF_FAMILY CANARY_ECR_REPO CANARY_ECR_URI CANARY_TABLE \
...
REQUIRED_KEYS="CANARY_CLUSTER CANARY_ALB_DNS CANARY_LISTENER_ARN CANARY_PRODUCTION_RULE_ARN CANARY_TG_PRIMARY CANARY_TG_ALTERNATE CANARY_SERVICE"
MISSING=""
